        ...
        <div class="col-md-4 ">
            <div class="card card-pricing card-raised">
                <div class="card-content content-primary">
                    ...
                    <h1 class="card-title"><small>{{config('app.currency_symbol')}} </small>10<small>.00</small></h1>
                    <ul>
        ...
        <div class="col-md-4">
            <div class="card card-pricing card-raised">
                <div class="card-content content-info">
                    ...
                    <h1 class="card-title"><small>{{config('app.currency_symbol')}} </small>50<small>.00</small></h1>
                    <ul>
        ...
        <div class="col-md-4">
            <div class="card card-pricing card-raised">
                <div class="card-content content-success">
                    ...
                    <h1 class="card-title"><small>{{config('app.currency_symbol')}} </small>100<small>.00</small></h1>
                    <ul>
