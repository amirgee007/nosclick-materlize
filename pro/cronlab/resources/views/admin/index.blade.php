        ...
        <div class="col-md-12">
                ...
                <div class="card-content">
                    <div class="alert alert-success alert-with-icon" data-notify="container">
                        ...
                        <span class="text-center" data-notify="message">Welcome {{Auth::user()->name}} !! You have received some request from your website user. By the way, Thanks or using this script.</span>
                        <br>
