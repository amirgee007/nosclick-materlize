                                                    ...
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable"
                                                            ...
                                                            <p style='color:#FFEECE;'>Hi {{$receiverName}}, <br/>
                                                                ...
                                                                Je vous ai envoyé € {{$amount}} de mon compte à
                                                                 votre {{$receiverEmail}}. Veuillez vérifier votre compte.
                                                             
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" align="center" width="200"
                                            ...
                                            <tr>
                                                <td bgcolor="#ED006F" align="center" style="border-radius:4px;"
                                                    ...
                                                    <div class="contentEditableContainer contentTextEditable">
                                                        <div class="contentEditable">
                                                            <a target='_blank' href="{{url('/login')}}" class='link2'>Connectez-vous à votre compte</a>
                                                        </div>
                                                    </div>
