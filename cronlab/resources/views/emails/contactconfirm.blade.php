                                                            ...
                                                            <td align='left'>
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align='center'>
                                                                        <h2>Nous avons reçu votre message</h2>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align='left'>
                                                                <div class="contentEditableContainer contentTextEditable">
                                                                    <div class="contentEditable" align='center'>
                                                                        <p>
                                                                            Merci de nous contacter. Nous avons reçu votre message. Nous répondons à votre message après la publication de votre publication. S'il vous plaît attendez un peu de temps. Merci de ne pas répondre à ce message.
                                                                            <br>
                                                                            <br>
                                                                            Cordialement,
                                                                            <br>
                                                                            <span style='color:#222222;'>{{env('APP_SUPPORT_NAME')}}</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
