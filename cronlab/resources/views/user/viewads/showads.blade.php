...
<head>
    ...
    <title>{{config('app.name')}} - Afficher le site internet</title>
...
<script>
    ...
    <iframe src="{{$advert->ptc->ad_link}}" style="border: 0; position:absolute; top: 10%; left:0; right:0; bottom:0; width:100%; height:100%"></iframe>
