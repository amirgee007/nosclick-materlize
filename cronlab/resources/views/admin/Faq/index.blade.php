...
@section('title', 'Toutes les FAQ du site')
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="card">
                ...
                <br>
                <h4 class="card-title">Toutes les FAQ du site</h4>
        ...
        <div class="col-md-5">
            <div class="card">
                ...
                <br>
                <h4 class="card-title">Créer une question fréquente</h4>
                <div class="card-content">
                    <br>
                    ...
                    <form class="m-form" action="{{route('adminFAQStore')}}" method="post">
                        ...
                        <button type="submit" class="btn btn-success pull-right">Créer F.A.Q</button>
