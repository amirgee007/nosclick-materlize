...
@section('title', 'Voir tout le blog')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <br>
                <h4 class="card-title">Tout le blog</h4>
                <div class="card-content">
                    ...
                    <div class="table-responsive">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <th class="text-center">Voir message</th>
                                <th class="text-center">Editer message</th>
                    ...
                    @else
                        ...
                        <h1 class="text-center">Aucun article de blog trouvé</h1>
