            ...
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title">Blog -
                        <small class="category">Modifier le blog</small>
                    </h4>
                    <form action="{{route('admin.posts.update',['id'=>$post->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label  class="control-label" for="content">Publier un contenu</label>
                        ...
                        <button type="submit" class="btn btn-success pull-right">Mettre à jour le profil</button>
