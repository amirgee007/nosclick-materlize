            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <form>
                        ...
                        <a href="{{route('adminKycReject',['id'=>$verify->id])}}" class="btn btn-danger">Demande refusé</a>
                        <a href="{{route('adminKycAccept',['id'=>$verify->id])}}" class="btn btn-success pull-right">Demande approuvé</a>
