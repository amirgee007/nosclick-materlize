        ...
        <nav class="navbar navbar-primary navbar-transparent navbar-absolute">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}"><img src="/img/logo.png"  title="NOSCLICK" alt="NOSCLICK" /></a>
                </div>
                ...
                <div class="collapse navbar-collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            @else
                                ...
                                <li><a href="{{ url('/contact-us') }}"> <i class="material-icons">contact_mail</i> Contact</a></li>
                                <li>
                                    <a href="{{ url('/user/dashboard') }}"> <i class="material-icons">dashboard</i> Tableau de bord </a>
                                </li>
                                <li>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="{{route('subscriber.runsetup', Auth::user()->id)}}"> <i class="material-icons">recent_actors</i> Mon profil </a>
                                            </li>
                                            <li>
                                                <a href="{{route('subscriber.runsetup', Auth::user()->id)}}"> <i class="material-icons">explicit</i> Editer le profil </a>
                                            </li>
                                            <li>
                                                <a href="#"> <i class="material-icons">usb</i> Paramètres </a>
                                            </li>
                                            <li>
                                                <a href="{{ route('logout') }}"
