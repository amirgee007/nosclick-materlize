...
class AdminEmailController extends Controller
{
    ...
    public function send(Request $request)
    {
        ...
        if ($request->status == 1){
            ...
            session()->flash('message', "Envoyer un e-mail à ".$user->name." Réussi!");
            Session::flash('type', 'success');
            Session::flash('title', 'Email envoyer avec succès!');
            ...
            session()->flash('message', "Envoyer un e-mail à ".$request->email." Réussi!");
            Session::flash('type', 'success');
            Session::flash('title', 'Email envoyer avec succès!');
