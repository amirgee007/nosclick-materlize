...
class AdminMembershipController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        session()->flash('message', 'L\'abonnement a été créée avec succès.');
    ...
    public function update(Request $request, $id)
    {
        ...
        session()->flash('message', 'L\'abonnement a été enregistrée avec succès.');
        Session::flash('type', 'success');
        Session::flash('title', 'Sauvegarder avec succès');
    ...
    public function destroy($id)
    {
        ...
        session()->flash('message', 'L\'abonnement a été supprimée avec succès.');
        Session::flash('type', 'success');
