...
class SettingsController extends Controller
{
    ...
    public function generalSettings(Request $request, $id){
        ...
        session()->flash('message', 'Les paramètres du site internet ont été modifiés avec succès');
        Session::flash('type', 'success');
        Session::flash('title', 'Mise à jour réussie');
    ...
    public function featuresSettings(Request $request, $id){
        ...
        session()->flash('message', 'Les paramètres des fonctionnalités du site internet ont été modifiés avec succès');
        Session::flash('type', 'success');
        Session::flash('title', 'Mise à jour réussie');
    ...
    public function usersSettings(Request $request, $id){
        ...
        session()->flash('message', 'Les paramètres des utilisateurs du site internet ont été modifiés avec succès');
        Session::flash('type', 'success');
        Session::flash('title', 'Mise à jour réussie');
