...
class AdminPPVController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        session()->flash('message', 'Le PPV a été créé avec succès.');
    ...
    public function update(Request $request, $id)
    {
        ...
        session()->flash('message', 'Le PPV a été mis à jour avec succès.');
        Session::flash('type', 'success');
    ...
    public function destroy($id)
    {
        ...
        session()->flash('message', 'Les annonces PPV ont été supprimées avec succès.');
        Session::flash('type', 'success');
