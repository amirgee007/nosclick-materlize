...
class KYC2VerifyAccept extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ...
                    ->line("Nous avons reçu votre demande de vérification d'adresse. N'hésitez pas à continuer de profité de nos services, durant notre processus de vérification.")
